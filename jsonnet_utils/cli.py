...
import click
import logging
from .grafana_dashboard import convert_dashboards, info_dashboards, test_dashboards
...
def dashboards_convert(source_path, build_path, format, layout):
...
@click.option('--layout', default='rows',
              help='Format of the dashboard: `normal` (scheme 14) , `grid` (scheme 16).')
def dashboards_test(path, scheme, layout):
